...
classdef Stimulus_Old < handle
    ...
    methods
        ...
        % constructor
        function obj = Stimulus_Old(trace,location,sampling_frequency,pin_radius)
            if nargin>3
        ...
        function compute_profile(obj)
            if(obj.initialized)
                [obj.profile, obj.profiledyn] = CircIndent2LoadProfile_Old...
        ...
        function [s,stat_comp,dyn_comp]=propagate(obj,aff,flag_distOnHand)
            ...
            stat_comp(:,idx)=CircLoadVertStress_Old(obj.profile,obj.location,...
